...
As we can see from the scatter plot above, a ***simple linear regression model is reasonable*** for this situation because there is a linear relationship present between the total land  and total income. This means that an increase in total land will also an increase in total income. </p>
